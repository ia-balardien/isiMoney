...
function calculTotalAnnée() {
    ...
    cotisation += calculCSGNonDeductible()[1] + calculCSGDeductible()[1] + calculCRDS()[1] + calculCotisationRAFP()[1][1];
    cotisation += calculCSGNonDeductible()[2] + calculCSGDeductible()[2] + calculCRDS()[2] + calculCotisationRAFP()[1][1];
    cotisation = 10 * (calculCSGNonDeductible()[0] + calculCSGDeductible()[0] + calculCRDS()[0] + calculCotisationRAFP()[1][0]);
...
function totalAssietteCSG() {
    ...
    var base_perf_juin = base + perf_var[1];
    var base_perf_dec = base + perf_var[2];

    var tab = [base, base_perf_juin, base_perf_dec];
